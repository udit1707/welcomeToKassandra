...
export const getCategories = () => {
    return async dispatch => {
        try{const response=await fetch('http://welcometokassandra.azurewebsites.net/allCategories',{
            method:'GET',
            headers:{
...
export const newProduct = (formData,token) => {
    return async dispatch => {
        try{const response=await fetch('http://welcometokassandra.azurewebsites.net/manufacturer/newProduct',{
            method:'POST',
            headers:{
        ...
        const response2=await fetch('http://welcometokassandra.azurewebsites.net/manufacturer/products',{
            method:'GET',
            headers:{
                'Authorization':'Bearer '+token 
            },
...
export const getProducts = (token) => {
    return async dispatch => {
        try{const response=await fetch('http://welcometokassandra.azurewebsites.net/manufacturer/products',{
            method:'GET',
            headers:{
                'Authorization':'Bearer '+token 
            },
...
export const getTopProducts = (token) => {
    return async dispatch => {
        try{const response=await fetch('http://welcometokassandra.azurewebsites.net/manufacturer/top-products',{
            method:'GET',
            headers:{
                'Authorization':'Bearer '+token 
            },
...
export const getTopRetialersForProduct = (prodId,token) => {
    return async dispatch => {
        try{const response=await fetch(`http://welcometokassandra.azurewebsites.net/manufacturer/top-retailers/${prodId} `,{
            method:'GET',
            headers:{
                'Authorization':'Bearer '+token 
            },
...
export const updateProductStock = (data,token) => {
    return async dispatch => {
        try{const response=await fetch('http://welcometokassandra.azurewebsites.net/manufacturer/updateprodStock',{
            method:'POST',
            headers:{
                'Content-Type':'application/json',
                'Authorization':'Bearer '+token 
...
export const updateUnits = (prodId,unitsToAdd,token) => {
    return async dispatch => {
        try{const response=await fetch('http://welcometokassandra.azurewebsites.net/manufacturer/updateUnits',{
            method:'POST',
            headers:{
                'Content-Type':'application/json',
                'Authorization':'Bearer '+token 
